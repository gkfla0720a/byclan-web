-- public.system_settings RLS 활성화 + 운영진/개발자 전용 정책
...
-- 4) 점검 쿼리
-- select tablename, rowsecurity from pg_tables where schemaname='public' and tablename='system_settings';
-- select policyname, permissive, cmd, roles, qual, with_check from pg_policies where schemaname='public' and tablename='system_settings';
