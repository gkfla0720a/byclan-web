 ...
 *
 * ■ HomeGate / Header / Footer 구조
 *   - (main)/layout.js 와 동일한 구조로 Header, HomeGate, Footer를 포함합니다.
 *   - 루트 '/' 경로가 (main) 라우트 그룹 밖에 있으므로 여기서 직접 처리합니다.
 *   - 향후 HomeGate를 제거하려면 NEXT_PUBLIC_HOME_GATE_ENABLED=false로 변경하면 됩니다.
 * =====================================================================
 */
'use client';
...
export default function Home() {
  ...
  // 일반 홈 화면 — (main)/layout.js 와 동일한 구조
  return (
    <HomeGate>
      <div className="min-h-screen flex flex-col bg-[#06060a] text-gray-200 font-semibold relative" style={{ fontFamily: "'Pretendard', sans-serif" }}>
        <Header />
